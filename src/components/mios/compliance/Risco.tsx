  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "340px 1fr", gap: 0, borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        ...
        {/* Left: Score + Matrix */}
        <div style={{ borderRight: "1px solid rgba(255,255,255,0.05)", background: "rgba(255,255,255,0.008)", backdropFilter: "blur(16px) saturate(180%)", WebkitBackdropFilter: "blur(16px) saturate(180%)", display: "flex", flexDirection: "column" }}>

          {/* Score ring + summary */}
          <div style={{ padding: "20px 20px 16px", display: "flex", gap: 20, alignItems: "center", background: "rgba(255,255,255,0.01)", backdropFilter: "blur(16px) saturate(180%)", WebkitBackdropFilter: "blur(16px) saturate(180%)", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
        ...
        {/* Right: Detail panel */}
        <div key={selected} style={{ padding: "24px", display: "flex", flexDirection: "column", gap: 16, background: "rgba(255,255,255,0.008)", backdropFilter: "blur(16px) saturate(180%)", WebkitBackdropFilter: "blur(16px) saturate(180%)", animation: "detail-in 0.2s ease" }}>
          {/* Severity badge + ID */}
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            <span style={{
              fontSize: 8, fontWeight: 900, letterSpacing: 2, padding: "4px 10px",
              background: ss.bg, backdropFilter: "blur(12px) saturate(160%)", WebkitBackdropFilter: "blur(12px) saturate(160%)",
              color: ss.color, border: `1px solid ${ss.border}`,
          ...
          {/* Risk description */}
          <div style={{ padding: "14px 16px", background: ss.bg, backdropFilter: "blur(16px) saturate(180%)", WebkitBackdropFilter: "blur(16px) saturate(180%)", border: `1px solid ${ss.border}`, borderLeft: `3px solid ${ss.color}`, borderRadius: "0 6px 6px 0" }}>
          ...
          {/* Action */}
          <div style={{ padding: "16px 18px", background: "rgba(255,149,0,0.05)", backdropFilter: "blur(16px) saturate(180%)", WebkitBackdropFilter: "blur(16px) saturate(180%)", border: "1px solid rgba(255,149,0,0.18)", borderTop: "2px solid rgba(255,149,0,0.4)", borderRadius: "0 0 8px 8px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: 0 }}>
        ...
        <div style={{ padding: "20px 20px 48px" }}>
          ...
          {/* Compliance CTA */}
          <div style={{ marginTop: 16, padding: "16px 16px", background: "rgba(255,149,0,0.04)", backdropFilter: "blur(16px) saturate(180%)", WebkitBackdropFilter: "blur(16px) saturate(180%)", border: "1px solid rgba(255,149,0,0.15)", borderRadius: 8 }}>
