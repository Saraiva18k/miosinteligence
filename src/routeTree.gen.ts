...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/social-intelligence' | '/concorrentes' | '/audiencia' | '/investimento'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/social-intelligence' | '/concorrentes' | '/audiencia' | '/investimento'
  id: '__root__' | '/' | '/social-intelligence' | '/concorrentes' | '/audiencia' | '/investimento'
